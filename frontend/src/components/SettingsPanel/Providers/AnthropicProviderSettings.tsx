...
export interface AnthropicProviderSettingsProps {
...
/**
 * Anthropic provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for Anthropic provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const AnthropicProviderSettings: React.FC<AnthropicProviderSettingsProps> = (props) => {
  return (
    <GenericProviderSettings providerName="anthropic" configKey="anthropic" {...props} />
  );
};

export default AnthropicProviderSettings;
