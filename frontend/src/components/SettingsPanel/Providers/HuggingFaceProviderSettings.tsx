...
export interface HuggingFaceProviderSettingsProps {
...
/**
 * HuggingFace provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for HuggingFace provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const HuggingFaceProviderSettings: React.FC<HuggingFaceProviderSettingsProps> = (props) => {
  return (
