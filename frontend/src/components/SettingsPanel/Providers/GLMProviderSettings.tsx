...
export interface GLMProviderSettingsProps {
...
/**
 * GLM provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 * <GLMProviderSettings
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for GLM provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const GLMProviderSettings: React.FC<GLMProviderSettingsProps> = (props) => {
  return (
    <GenericProviderSettings providerName="glm" configKey="glm" {...props} />
  );
};

export default GLMProviderSettings;
