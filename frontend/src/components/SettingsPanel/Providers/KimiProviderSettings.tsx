...
export interface KimiProviderSettingsProps {
...
/**
 * Kimi provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for Kimi provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const KimiProviderSettings: React.FC<KimiProviderSettingsProps> = (props) => {
  return (
    <GenericProviderSettings providerName="kimi" configKey="kimi" {...props} />
  );
};

export default KimiProviderSettings;
