...
export interface XAIProviderSettingsProps {
...
/**
 * xAi provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 * <XAIProviderSettings
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for xAi provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const XAIProviderSettings: React.FC<XAIProviderSettingsProps> = (props) => {
  return (
    <GenericProviderSettings providerName="xai" configKey="xai" {...props} />
  );
};

export default XAIProviderSettings;
