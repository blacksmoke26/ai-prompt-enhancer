...
export interface NvidiaProviderSettingsProps {
...
/**
 * Nvidia provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for Nvidia provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const NvidiaProviderSettings: React.FC<NvidiaProviderSettingsProps> = (props) => {
  return (
    <GenericProviderSettings providerName="nvidia" configKey="nvidia" {...props} />
  );
};

export default NvidiaProviderSettings;
