...
export interface QianFanProviderSettingsProps {
...
/**
 * QianFan provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for QianFan provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const QianFanProviderSettings: React.FC<QianFanProviderSettingsProps> = (props) => {
  return <GenericProviderSettings providerName="qianfan" configKey="qianfan" {...props} />;
};

export default QianFanProviderSettings;
