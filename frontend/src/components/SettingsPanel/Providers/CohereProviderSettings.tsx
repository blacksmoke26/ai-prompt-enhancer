...
export interface CohereProviderSettingsProps {
...
/**
 * Cohere provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for Cohere provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const CohereProviderSettings: React.FC<CohereProviderSettingsProps> = (props) => {
  return (
    <GenericProviderSettings providerName="cohere" configKey="cohere" {...props} />
  );
};

export default CohereProviderSettings;
