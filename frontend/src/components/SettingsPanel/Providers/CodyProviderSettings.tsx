...
export interface CodyProviderSettingsProps {
...
/**
 * Cody provider settings component that wraps GenericProviderSettings with provider-specific configuration.
 *
 * Example usage:
 * ```tsx
 ...
 * ```
 *
 * @developer-note This component serves as a specialized wrapper for Cody provider configuration,
 * leveraging the GenericProviderSettings component with pre-configured provider-specific props.
 */
const CodyProviderSettings: React.FC<CodyProviderSettingsProps> = (props) => {
  return (
    <GenericProviderSettings providerName="cody" configKey="cody" {...props} />
  );
};

export default CodyProviderSettings;
