...
import {Check, ChevronDown, Copy, Eye, EyeOff, Loader2, AlertCircle} from 'lucide-react';
import {cn} from '~/utils/helpers.ts';

/**
 * Types for the design system
 */
type InputSize = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'plain';
type InputVariant = 'default' | 'filled' | 'floating' | 'ghost';
type InputColor = 'default' | 'primary' | 'secondary' | 'destructive' | 'success';
type MaskPattern = 'phone' | 'credit-card' | 'date' | 'numeric' | 'custom';
