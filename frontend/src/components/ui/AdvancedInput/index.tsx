    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        >
          ...
          {/* Text Prefix (Static) */}
          {prefix && !isTagsMode && (
            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground pointer-events-none z-10 text-sm">
              {prefix}
            </div>
          )}
          ...
          {/* Text Suffix (Static) */}
          {suffix && !isTagsMode && (
            <div className="absolute right-8 top-1/2 -translate-y-1/2 text-muted-foreground pointer-events-none z-10 text-sm">
              {suffix}
            </div>
          )}
          ...
          <div className={cn(
            ...
            {!loading && rightIcon && !isTagsMode && <div className="text-muted-foreground pointer-events-none">{rightIcon}</div>}
