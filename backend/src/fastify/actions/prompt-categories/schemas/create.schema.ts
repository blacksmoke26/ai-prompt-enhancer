...
export default {
  summary: 'Create',
  description: 'Creates a new prompt template category',
  ...
  response: {
    ...
    500: schema500WithError('Failed to create prompt category'),
    200: schema200WithData({
      type: 'object',
      properties: {
        id: {
          type: 'number',
          description: 'Unique identifier for the created category',
          examples: [1],
        },
        key: {
          type: 'string',
