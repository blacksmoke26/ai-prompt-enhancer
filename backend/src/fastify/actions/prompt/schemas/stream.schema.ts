...
// constants
import { bodyProperties } from './utils/prompt-schema';
...
export default {
  summary: 'Stream',
  description:
    'Parameters for configuring AI prompt generation with fine-grained control over content, style, and model behavior.',
  tags: ['Prompt'],
  security: [],
  body: {
    type: 'object',
