...
export default {
  summary: 'Update',
  description: 'Updates the response length identified by the provided key',
  ...
  response: {
    400: schema400WithError('Failed to update response length'),
    404: schema404WithError('Response length not found'),
