...
export default {
  ...
  description:
    'Retrieves a paginated list of prompt templates filtered by category ID. Supports pagination, sorting, and search.',
  ...
  response: {
    500: schema500WithError('Failed to get templates by category'),
